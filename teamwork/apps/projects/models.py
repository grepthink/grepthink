...
class ProjectChat(models.Model):
    ...
    def __str__(self):
        return '{0} - {1}'.format(self.plans.username, self.content)


class ProjectPlan(models.Model):
    project = models.ForeignKey(Project, related_name='plan', on_delete=models.CASCADE)
    create_user = models.ForeignKey(User, related_name='plan_user', on_delete=models.CASCADE)
    date = models.DateTimeField(auto_now_add=True, editable=True)
    content = models.CharField(max_length=2000, default="")
    class Meta:
